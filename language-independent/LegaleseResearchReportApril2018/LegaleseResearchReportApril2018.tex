...
where the \timestamp argument is the \timestamp of the previous \einst. The \ename parameters are completely determined by the rule and the current state since a deadline \einst is created by the contract itself. 
