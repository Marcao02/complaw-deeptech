...
\end{PPI}
Let \firstuse{$\info{\cdot,\cdot,\cdot}$}{info} be your function for extracting the $\serv$ from the data one has at the end of a consistent symbolic execution path (currently $\svtosmt, P, s$). We will generalize that later, most importantly for extracting information from consistent execution paths that contain errors.

\begin{defn}[\cF-consistent]
