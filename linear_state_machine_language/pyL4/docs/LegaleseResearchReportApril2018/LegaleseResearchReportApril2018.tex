...
\newcommand{\lsmclass}[1]{\texorpdfstring{\textsf{\hyperref[lsmclass]{CSM}}{CSM(F)}}(#1)}
\newcommand{\timelesslsmclass}[1]{\texorpdfstring{\textsf{\hyperref[timeless-lsmclass]{timeless-CSM}}{timeless-CSM(F)}}(#1)}
...
We take seriously the tenant that DSL development should be guided by usage. Others do not.
