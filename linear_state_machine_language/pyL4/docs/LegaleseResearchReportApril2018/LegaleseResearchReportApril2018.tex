...
We go one step further by introducing some minimal structure into the $\statetransforms$, which has a role in \refstyle{\hyperref[symbexec]{symbolic execution}}. 
