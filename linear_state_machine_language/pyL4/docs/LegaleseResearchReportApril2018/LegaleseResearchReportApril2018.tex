...
\larger\noindent{\bf Execution of \lsms}\smaller \\
...
We now officially modify the specification of \lsm to say that each \statetransform{e} is \stransimpl (instead of just being a set of functions of types $\{ \timestamp^2 \times \VDom \times \eparamtypes{e} \rarr \VDom(x) \ | \ x \in \statevars \}$). 

\subsection{Final Specification of \lsm}
