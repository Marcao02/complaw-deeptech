...
$r$ also has a {\it parameter setter} $\firstuse{\textcolor{blue}{\params{r}}}{params}$ of type
...
Symbolic execution is model checking for languages with unbounded datatypes. 

\subsection{Exhaustive Model Checking for bounded or nearly-bounded state spaces}
