...
# If u has an uncounted delegation to v, and v has not acted or also
# has an uncounted delegation, then u can change their delegation to
# another voter w, provided w either directly voted or has a counted
# delegation. This allows for two things, with (1) being its purpose
# and (2) being a side effect.
